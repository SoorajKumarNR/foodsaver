...
class MapComp extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            backendData: null // To store data fetched from backend
        }
    }

    componentDidMount() {
        // Existing Geocode call
        ...
        // Fetch data from backend API using apiUrl
        this.fetchDataFromBackend();
    }

    // New method to fetch data from backend API
    fetchDataFromBackend = () => {
        fetch(`${apiUrl}/your-api-endpoint`)
            .then(res => res.json())
            .then(data => {
                console.log("Data from backend API", data);
                this.setState({ backendData: data }); // Store or use as needed
            })
